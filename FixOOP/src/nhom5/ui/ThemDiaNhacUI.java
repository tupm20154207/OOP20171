 ...
 * @author Hoai Nguyen
 */
public class ThemDiaNhacUI extends javax.swing.JFrame {
    ...
    private void btnThemNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemNActionPerformed
        ...
        if(	   txtMaSanPhamN.getText().isEmpty() || txtTenSanPhamN.getText().isEmpty() || txtCaSi.getText().isEmpty() || txtTheLoaiN.getText().isEmpty()
					|| txtGiaMuaN.getText().isEmpty() ||	txtGiaBanN.getText().isEmpty() ||	txtSoLuongN.getText().isEmpty()) {
					sendMess("Yeu cau nhap du thong tin.");
				}
				else {
					try {
					   DiaNhac dn = new DiaNhac(txtMaSanPhamN.getText(), txtTenSanPhamN.getText(), Integer.parseInt(txtGiaMuaN.getText()), 
												Integer.parseInt(txtGiaBanN.getText()), Integer.parseInt(txtSoLuongN.getText()), 
