...
public class testNhanVienUI {
    public static void main(String args[]){
        ...
        QuanLy.themSanPham(new DiaNhac(TienIch.sinhMaSP("dn"), "24K", 1, 1, 3,"bruno mars","pop"));
        QuanLy.themSanPham(new DiaPhim(TienIch.sinhMaSP("dp"), "Inception", 2, 12,4,"christopher nolan","asd"));
        QuanLy.themSanPham(new Sach(TienIch.sinhMaSP("s"),"Sherlock Holmes",3,5,2,"conan doyle","dfg"));
